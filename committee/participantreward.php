    ...
    <main class="container-fluid p-5 text-white bg-dark2" >
      <div class="row justify-content-md-center">
        <div class="col-5 bg-dark p-5">
          ...
          <?php 
            if (isset($_GET['id']) && isset($_GET['em'])) {
              $tId = $_GET['id'];
              $tEmail = $_GET['em'];
            } else {
           ...
           ?>
          <form method="post" action="participantrewardprocess.php" enctype="multipart/form-data">
            <div class="form-group">
              <label>Ticket Id</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="ticketid" value="<?=$tId?>" readonly>
            </div>
            <div class="form-group">
              <label>Email</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="ticketemail" value="<?=$tEmail?>" readonly>
            </div>
            <label>Reward</label>
            <div class="form-group">
              <input type="file" name="reward" id="customFile" style="display: block; border: 0.1px solid white; border-radius: 0; width: 100%; padding: 4px;">
            </div>
