  ...
  <!-- ------------------------------------------------ CONTENT ----------------------------------------------- -->
    ...
    <main class="container-fluid p-5 text-white bg-dark2" >
      <div class="row justify-content-md-center p-5">
        <div class="col-6 bg-dark p-5 center">
          <h2 class="text-warning m-4">Are You Sure?</h2>
          <h4 class="mb-4">delete this event forever?</h4>
            <a class="btn btn-danger btn-lg rounded-0 mx-3" href="event_deleteprocess.php" role="button">Yes</a>
            <a class="btn btn-success btn-lg rounded-0 mx-3" href="event_detail.php" role="button">No</a>
        </div>
      </div>
    </main>
