    ...
    <main class="container-fluid p-5 text-white bg-dark2" >
      <div class="row justify-content-md-center">
        <div class="col-6 bg-dark p-5">
          ...
          <form method="post" action="event_rundownaddprocess.php">
            <div class="form-group">
              <label>Activity</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="activity" placeholder="Activity" required>
            </div>
            <div class="form-group">
              <label>Start Time</label>
              <input type="time" class="form-control bg-transparent text-white rounded-0" name="starttime" required>
            </div>
            <div class="form-group">
              <label>End Time</label>
              <input type="time" class="form-control bg-transparent text-white rounded-0" name="endtime" required>
            </div>
            <div class="form-group">
              <label>Performer</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="performer" placeholder="Performer">
            </div>
            <div class="form-group">
              <label>Information</label>
              <textarea class="form-control bg-transparent text-white rounded-0" name="information" rows="3"></textarea>
            </div>
            <div class="form-group py-1">
              <button type="submit" class="mt-4 btn btn-success btn-block rounded-0" name="submit">Add</button>
            </div>
          </form>
        </div>
      </div>
