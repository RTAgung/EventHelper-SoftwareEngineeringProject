    ...
    <main class="container-fluid p-5 text-white bg-dark2" >
      <div class="row justify-content-md-center">
        <div class="col-6 bg-dark p-5">
          ...
          <form method="post" action="event_incomeaddprocess.php">
            <div class="form-group">
              <label>Source</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="source" placeholder="Source" required>
            </div>
            <div class="form-group">
