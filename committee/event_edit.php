      ...
      <div class="row justify-content-md-center">
        <div class="col-7 bg-dark p-5">
          ...
          <?php
           ...
           ?>
          <form method="post" action="event_editprocess.php">
            <div class="form-group">
              <label>Name</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="name" value="<?=$rowEvent->Name?>" placeholder="Name" required>
            </div>
            <div class="form-group">
              <label>City</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="city" value="<?=$rowEvent->City?>" placeholder="City" required>
            </div>
            <div class="form-group">
              <label>Location</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="location" value="<?=$rowEvent->Location?>" placeholder="Location" required>
            </div>
            <div class="form-group">
              <label>Start Date and Time</label>
              <?php 
                $startdate = date("Y-m-d\TH:i", strtotime($rowEvent->StartDateTime));
               ?>
              <input type="datetime-local" class="form-control bg-transparent text-white rounded-0" name="startdatetime" value="<?=$startdate?>" required>
            </div>
            <div class="form-group">
              <label>End Date and Time</label>
              <?php 
                $enddate = date("Y-m-d\TH:i", strtotime($rowEvent->EndDateTime));
               ?>
              <input type="datetime-local" class="form-control bg-transparent text-white rounded-0" name="enddatetime" value="<?=$enddate?>" required>
            </div>
            <div class="form-group">
              <label>Company</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="company" value="<?=$rowEvent->Company?>" placeholder="Company" required>
            </div>
            <div class="form-group">
              <label>Quota</label>
              <input type="number" class="form-control bg-transparent text-white rounded-0" name="quota" value="<?=$rowEvent->Quota?>"placeholder="Quota" required>
            </div>
            <div class="form-group">
              <label>Price</label>
              <input type="number" class="form-control bg-transparent text-white rounded-0" name="price" value="<?=$rowEvent->Price?>" placeholder="Price" required>
            </div>
            <div class="form-group">
