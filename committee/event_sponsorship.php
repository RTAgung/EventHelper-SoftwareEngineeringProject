    ...
    <main class="container-fluid p-5 text-white bg-dark2" >
      <div class="row justify-content-md-center">
        <div class="col-5 bg-dark p-5">
          <h1 class="text-center mb-4">EDIT SPONSORSHIP</h1>
          <?php
           ...
           ?>
          <form method="post" action="event_sponsorshipprocess.php">
            <div class="form-group">
              <label>Sponsorship</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="sponsorship" value="<?=$rowEvent->Sponsorship?>" placeholder="Sponsorship">
            </div>
