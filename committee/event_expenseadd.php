    ...
    <main class="container-fluid p-5 text-white bg-dark2" >
      <div class="row justify-content-md-center">
        <div class="col-6 bg-dark p-5">
          ...
          <form method="post" action="event_expenseaddprocess.php">
            <div class="form-group">
              <label>Object</label>
              <input type="text" class="form-control bg-transparent text-white rounded-0" name="object" placeholder="Object" required>
            </div>
            <div class="form-group">
              <label>Quantity</label>
              <input type="number" class="form-control bg-transparent text-white rounded-0" name="quantity" required>
            </div>
            <div class="form-group">
              <label>Price</label>
              <input type="number" class="form-control bg-transparent text-white rounded-0" name="price" required>
            </div>
            <div class="form-group">
