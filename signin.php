...
<body class="bg-dark">
  ...
  <main class="container-fluid p-5 text-white" >
    <div class="row justify-content-md-center">
      <div class="col-5 bg-dark2 p-5">
        <h1 class="text-center mb-4">SIGN IN</h1>
        <form method="post" action="signinprocess.php">
          <div class="form-group">
            <label>Email</label>
            <input type="email" class="form-control bg-transparent text-white rounded-0" name="email" placeholder="Email">
          </div>
          <div class="form-group">
            <label>Password</label>
            <input type="password" class="form-control bg-transparent text-white rounded-0" name="password" placeholder="Password">
          </div>
